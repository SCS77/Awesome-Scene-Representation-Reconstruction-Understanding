...
## <b><span style="color:white; background-color:red;">README.md for reconstruction and paper collection (For detailed papers on scene-related domains, please refer to: Representation-Reconstruction-Understanding.md For AIGC-3D-related content, please refer to: Awesome-AIGC-3D.md)</span></b>
